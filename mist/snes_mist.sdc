...
set_multicycle_path -from [get_clocks {pll|altpll_component|auto_generated|pll1|clk[2]}] -to [get_clocks {pll|altpll_component|auto_generated|pll1|clk[1]}] -setup 2
set_multicycle_path -from [get_clocks {pll|altpll_component|auto_generated|pll1|clk[2]}] -to [get_clocks {pll|altpll_component|auto_generated|pll1|clk[1]}] -hold 1
...
set_multicycle_path -from {main:main|SNES:SNES|DSP:DSP|*} -to {sdram:sdram|sd_a[*]} -hold -end 2
